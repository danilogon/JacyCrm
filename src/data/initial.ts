...
export const MOTIVOS_PERDA_RENOVACAO: MotivoPerda[] = [
  { id: 'mr1', nome: 'Cliente não renovou por preço',        tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: false, ativo: true, ordem: 1, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'mr2', nome: 'Cliente mudou de seguradora',          tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: false, ativo: true, ordem: 2, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'mr3', nome: 'Cliente cancelou o seguro',            tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: false, ativo: true, ordem: 3, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: true,  geraProspeccao: false },
  { id: 'mr4', nome: 'Não conseguimos contato',              tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: true,  ativo: true, ordem: 4, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'mr5', nome: 'Cliente insatisfeito com atendimento', tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: false, ativo: true, ordem: 5, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: true,  geraProspeccao: false },
  { id: 'mr6', nome: 'Apenas simulação/consulta',            tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: true,  ativo: true, ordem: 6, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'mr7', nome: 'Outros motivos',                       tipo: 'negocio', aplicaRenovacoes: true, aplicaSegurosNovos: true,  ativo: true, ordem: 7, considerarTaxaConversaoRenovacoes: true,  considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
];

export const MOTIVOS_PERDA_PROSPECCAO: MotivoPerda[] = [
  { id: 'mp1', nome: 'Sem interesse no momento',             tipo: 'prospeccao', aplicaRenovacoes: false, aplicaSegurosNovos: false, ativo: true, ordem: 1, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'mp2', nome: 'Já possui seguro com outro corretor',  tipo: 'prospeccao', aplicaRenovacoes: false, aplicaSegurosNovos: false, ativo: true, ordem: 2, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'mp3', nome: 'Preço não competitivo',                tipo: 'prospeccao', aplicaRenovacoes: false, aplicaSegurosNovos: false, ativo: true, ordem: 3, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'mp4', nome: 'Sem contato / não respondeu',          tipo: 'prospeccao', aplicaRenovacoes: false, aplicaSegurosNovos: false, ativo: true, ordem: 4, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'mp5', nome: 'Outros motivos',                       tipo: 'prospeccao', aplicaRenovacoes: false, aplicaSegurosNovos: false, ativo: true, ordem: 5, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
];

export const MOTIVOS_PERDA_SEGURO_NOVO: MotivoPerda[] = [
  { id: 'ms1', nome: 'Preço não competitivo',           tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 1, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'ms2', nome: 'Cliente desistiu da contratação', tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 2, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: false },
  { id: 'ms3', nome: 'Documentação incompleta',         tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 3, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'ms4', nome: 'Cliente escolheu outro corretor', tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 4, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'ms5', nome: 'Não aprovado pela seguradora',    tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 5, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: false },
  { id: 'ms6', nome: 'Cliente não respondeu',           tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 6, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
  { id: 'ms7', nome: 'Apenas cotação/simulação',        tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 7, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'ms8', nome: 'Cliente teste interno',           tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 8, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: false, considerarCalculoMetas: false, geraProspeccao: false },
  { id: 'ms9', nome: 'Outros motivos',                  tipo: 'negocio', aplicaRenovacoes: false, aplicaSegurosNovos: true, ativo: true, ordem: 9, considerarTaxaConversaoRenovacoes: false, considerarTaxaConversaoSegurosNovos: true,  considerarCalculoMetas: true,  geraProspeccao: true  },
];
...
export const TIPOS_USUARIO_INICIAIS: TipoUsuario[] = [
  {
    ...
    visualizarDashboard: true, visualizarProducao: true, visualizarMetas: true, visualizarComissoes: true, visualizarLookalike: true,
  ...
  },
  {
    ...
    acessoRenovacoes: true, acessoSegurosNovos: true, acessoProspeccao: true, podeDescartarProspeccao: true, acessoConsultaRenovacoes: false,
    visualizarDashboard: true, visualizarProducao: true, visualizarMetas: true, visualizarComissoes: false, visualizarLookalike: true,
    camposRestritos: { renovacoes: [], segurosNovos: [], prospeccoes: [] },
    ativo: true,
  },
  {
  ...
  },
  {
    ...
    visualizarDashboard: true, visualizarProducao: false, visualizarMetas: false, visualizarComissoes: false, visualizarLookalike: false,
    camposRestritos: { renovacoes: [], segurosNovos: [], prospeccoes: [] },
    ativo: true,
  },
];
