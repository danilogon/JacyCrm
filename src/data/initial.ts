...
export const SEGURADORAS_INICIAIS: Seguradora[] = [
  { id: 's1', nome: 'Allianz', ativo: true },
  { id: 's2', nome: 'Bradesco Seguros', ativo: true },
  { id: 's3', nome: 'Itaú Seguros', ativo: true },
  { id: 's4', nome: 'Mapfre', ativo: true },
  { id: 's5', nome: 'Porto Seguro', ativo: true },
  { id: 's6', nome: 'SulAmérica', ativo: true },
];
