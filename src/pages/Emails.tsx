...
import {
  ...
  Settings, Bell, Users, Plus, Edit2, Trash2, X,
} from 'lucide-react';
import type { ModeloEmail, EmailDisparo, GatilhoEmail, Cliente, SeguroNovo, Renovacao, Usuario } from '../types';
...
type Tab = 'modelos' | 'disparos' | 'configuracoes';
...
const VARIAVEIS_HELP = 'Variáveis disponíveis: {{nome}}, {{email}}, {{produto}}, {{seguradora}}, {{vencimento}}';
            ...
            <div className="flex-1 px-5 py-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={12}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-y font-mono"
                  placeholder="Olá {{nome}},&#10;&#10;Seu seguro de {{produto}} está próximo do vencimento..."
                />
                <p className="text-xs text-gray-400 mt-1">{VARIAVEIS_HELP}</p>
              </div>
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Gerencie modelos, disparos automáticos e campanhas de e-mail</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl w-fit">
        ...
        <button onClick={() => setTab('disparos')} className={tabClass('disparos')}>
          ...
          Disparos
          {pendentesCount > 0 && (
            <span className="ml-1 min-w-[18px] h-4.5 px-1 bg-yellow-400 text-yellow-900 text-[10px] font-bold rounded-full flex items-center justify-center">
      ...
      {/* Suppress unused import warning for usuarios */}
